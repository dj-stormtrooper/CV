  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Senior Software Engineer}{May 2022 \textbf{--} Sep 2022}
        \resumeItemListStart
            \resumeItem{Developed Cloudquery website using NextJS, React, TypeScript and moved blog from custom solution to CMS to remove maintenance overhead}
            \resumeItem{Collaborated with core team for maintaining open-source projects of Cloudquery}
            \resumeItem{Architected scalable test infrastructure for Cloudquery Integration marketplace, utilizing tools like Playwright and Jest, resulting in a 70\% increase in test coverage}
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Senior Frontend Engineer}{Aug 2018 \textbf{--} Jul 2022}
        \resumeItemListStart
            ...
            \resumeItem{Engineered CI/CD pipeline with Github Actions, reducing feature delivery time by 50\%}
    ...
    \resumeSubheading
      ...
      {Frontend Engineer}{May 2017 \textbf{--} Aug 2018}
        \resumeItemListStart
          \resumeItem{Adopted React for the new version of the Megaplan CRM, increasing feature delivery speed}
          \resumeItem{Developed new Megaplan mobile application, significantly saved time spent on developing by adopting React Native as a mobile framework}
